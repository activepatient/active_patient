...
//     if (!acceptTerms) {
//       Toast.show("Please accept terms and conditions", { backgroundColor: "#ef4444" });
//       return;
//     }

//     if (!email || !password || !firstName || !lastName) {
//       Toast.show("Please fill all mandatory fields", { backgroundColor: "#ef4444" });
//       return;
//     }
...
//           </TouchableOpacity>
//           <Text style={{ marginLeft: 8 }}>Accept terms and conditions</Text>
//         </View>
...
//           disabled={isLoading}
//         >
//           {isLoading ? <ActivityIndicator color="#fff" /> : <Text style={{ color: "#fff", fontWeight: "bold" }}>Register</Text>}
//         </TouchableOpacity>

//         {/* Status message */}
//         {message && (
//           <Text style={[styles.status, status === "Success" ? styles.success : styles.error]}>
//             {message}
//           </Text>
//         )}
//       </View>
