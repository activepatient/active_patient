...
// const STRIPE_KEY = "pk_test_51SRUXjLZaQ3RKFGpCmwiPYuyUKGSfmqdIxjn9ef4ZLqjHJUm7nvkHmcKzg9dkiMsPuUQFNcK5ACn8psZOW9fuB2j00vQfMLUtY";
// const BACKEND_URL = "https://isela-ungrumpy-undiligently.ngrok-free.dev";
...
//           </Text>
//           <Text style={styles.planDesc}>
//             Perfect for a one-off check-up.
//           </Text>
...
const BACKEND_URL = "https://isela-ungrumpy-undiligently.ngrok-free.dev"; // ⚠️ Replace with your ngrok URL
  ...
  const handlePayment = async () => {
    try {
      ...
      if (present.error) {
        ...
        // ✅ Redirect dynamically based on source
        setTimeout(() => {
